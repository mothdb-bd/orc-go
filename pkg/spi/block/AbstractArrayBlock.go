...
type IArrayBlock interface {
	Block // 继承block
	getRawElementBlock() Block
	GetOffsets() []int32
	GetOffsetBase() int32
	getOffset(position int32) int32
}
...
func (ak *AbstractArrayBlock) getRawElementBlock() Block {
	return nil
}
...
func (ak *AbstractArrayBlock) getOffset(position int32) int32 {
...
func (ak *AbstractArrayBlock) checkReadablePosition(position int32) error {
