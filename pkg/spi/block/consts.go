...
var (
	MaxI128 = Int128{hi: 0x7FFFFFFFFFFFFFFF, lo: 0xFFFFFFFFFFFFFFFF}
	MinI128 = Int128{hi: 0x8000000000000000, lo: 0}
	MaxU128 = Uint128{hi: maxUint64, lo: maxUint64}
	...
	// minI128AsU128 is used for the Int128.AbsU128() overflow case where the
	// Int128 == MinI128.
	minI128AsU128 = Uint128{hi: 0x8000000000000000, lo: 0x0}
